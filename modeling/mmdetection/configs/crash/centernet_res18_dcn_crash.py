_base_ = [
    '../_base_/datasets/crash_detection.py',
    '../_base_/schedules/schedule_1x.py', '../_base_/default_runtime.py'
]

model = dict(
    init_cfg = dict(type='Pretrained',checkpoint='pretrained/det/centernet_resnet18_dcnv2_140e_coco_20210702_155131-c8cd631f.pth'),
    type='CenterNet',
    backbone=dict(
        type='ResNet',
        depth=18,
