'''
@File: mix_data_crash_ablation.py.py
@Software: PyCharm
...
import os
'''
Crash2024+Train_half-->Val_half
cd datasets
mkdir -p mix_crash_ch/annotations
cp Crash-Seq/annotations/val_half.json mix_crash_ch/annotations/val_half.json
cp Crash-Seq/annotations/test.json mix_crash_ch/annotations/test.json
cd mix_crash_ch
...
crash_json = json.load(open('./datasets/Crash-Seq/annotations/train_half.json','r'))
img_list = list()
...
json.dump(mix_json,open('./datasets/mix_crash_ch/annotations/train.json','w'))